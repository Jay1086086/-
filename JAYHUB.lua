...
local InkGameTab = Window:Tab({Title = "自然灾害", Icon = "skull"})do
...
local InkGameTab = Window:Tab({Title = "死铁轨", Icon = "eye"})do
    InkGameTab:Section({Title = "英文"})
    InkGameTab:Button({
        Title = "JAY",
        Desc = "单击以执行",
        Callback = function()
