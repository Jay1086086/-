...
1. 修复了彩虹边框效果：修正了 ColorSequence 的格式错误，添加了缺失的闭合括号和引号
2. 修复了飞行脚本URL：替换了无效的URL为一个有效的飞行脚本URL
3. 移除了多余的 Locked 参数：Toggle 元素不需要 Locked 参数
4. 添加了UI关闭时的清理功能：确保穿墙模式和夜视功能在关闭UI时正确清理
